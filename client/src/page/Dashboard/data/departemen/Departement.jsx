...
import AddDepartement from "../../../../component/CRUD/departement/AddDepartement";
import UpdateDepartement from "../../../../component/CRUD/departement/UpdateDepartement";
import DeletedDepartement from "../../../../component/CRUD/departement/DeletedDepartement";
  ...
  const getDataDepartement = async () => {
    try {
      const respon = await axios.get(
        ` http://localhost:5000/api/v1/departemen?search=${keyword}&page=${page}&limit=${limit}`
      );
      // console.log(respon)
            ...
            <div className="row">
              <div className="col-sm-12">
                <div className="statistics-details d-flex align-items-center justify-content-between">
                  <div>
                    <p className="statistics-title">Total Departement</p>
            ...
            <div className="col-lg-12 grid-margin stretch-card">
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title">Table Departement</h4>
                  <nav className="navbar navbar-expand-lg navbar-light bg-transparent">
                    <div className="container-fluid">
                      ...
                      <AddDepartement isLoad={getDataDepartement} />
                    </div>
                  </nav>
                            ...
                            <tr key={data.id_dpm}>
                              ...
                              <td>
                                <div className="d-flex gap-3">
                                  <UpdateDepartement
                                    isUpdate={getDataDepartement}
                                    datas={data}
                                  />
                                  <DeletedDepartement
                                    isDeleted={getDataDepartement}
                                    data={data}
                                  />
                                </div>
                              </td>
...
export default DataDepartement;
