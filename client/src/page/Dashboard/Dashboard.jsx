...
const Dashboard = () => {
  ...
  return (
    <Layout>
      ...
      {user && user.data.role === "departement"&& (
        <div>
          <div className="d-sm-flex align-items-center justify-content-between border-bottom">
            <ul className="nav nav-tabs" role="tablist"></ul>
          </div>
          ...
          <div className="row">
            ...
            <div class="col-sm-3  mt-4">
              <a className="card-dashboard" href="/entrykhs">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Entry KHS</h4>
                    <div class="media">
                      <i class="fas fa-solid fa-table icon-md text-info d-flex align-self-center me-3"></i>
                      <div class="media-body"></div>
                    </div>
            ...
            <div class="col-sm-3  mt-4">
              <a className="card-dashboard" href="/entrypkl">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Entry PKL</h4>
                    <div class="media">
                    <i class="fas fa-solid fa-table icon-md text-info d-flex align-self-center me-3"></i>
                      <div class="media-body"></div>
                    </div>
            ...
            <div class="col-sm-3  mt-4">
              <a className="card-dashboard" href="/entryskripsi">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Entry SKRIPSI</h4>
                    <div class="media">
                    <i class="fas fa-solid fa-table icon-md text-info d-flex align-self-center me-3"></i>
                      <div class="media-body"></div>
                    </div>
            ...
            <div class="col-sm-3  mt-4">
              <a className="card-dashboard" href="/entryirs">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Entry IRS</h4>
                    <div class="media">
                    <i class="fas fa-solid fa-table icon-md text-info d-flex align-self-center me-3"></i>
                      <div class="media-body"></div>
                    </div>
