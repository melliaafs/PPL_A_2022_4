...
import DataDepartement from "./page/Dashboard/data/departemen/Departement";
import RekapDosen from "./page/rekapan/RekapDosen";
  ...
  return (
    ...
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/departemen" element={<DataDepartement />} />
        ...
        <Route path="/datadosen" element={<RekapDosen />} />
